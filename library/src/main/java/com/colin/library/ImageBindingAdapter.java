package com.colin.library;//package com.ifenghui.imageloaderlibrary;
//
...
//        GlideImageLoader.getInstance().displayCircleWithdrawable(view,imageCircleUrl==null ? defaultSrc : imageCircleUrl).intoTargetView(view);
